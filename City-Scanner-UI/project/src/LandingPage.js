      ...
      <div>
              ...
              <div className="col-md-10 col-lg-8 col-xl-7 mx-auto">
                <form>
                  ...
                  <div className="col-12 col-md-9 mb-2 mb-md-0">
                          <input type="text" className="form-control form-control-lg" placeholder="Enter City Name..." name="location"
        ...
        <section className="showcase">
          <div className="container-fluid p-0">
            ...
            <div className="row no-gutters">
              <div className="col-lg-6 text-white showcase-img" style={{backgroundImage: 'url("img/bg-showcase-4.jpg")'}} />
              <div className="col-lg-6 my-auto showcase-text">
                <h2>Events</h2>
                <p className="lead mb-0">Newly improved, and full of great utility classes, Bootstrap 4 is leading the way in mobile responsive web development! All of the themes on Start Bootstrap are now using Bootstrap 4!</p>
              </div>
